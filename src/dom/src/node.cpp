...
namespace dom
{
    ...
    Node* Node::nextSibling(void)
    {
        ...
        std::ostream& operator<<(std::ostream& os, Node& node)
        {
            ...
            AttributeList::iterator attrIterator = node.attributes.begin();
            
            for(; attrIterator != node.attributes.end(); attrIterator++)
            {
                os << (*attrIterator).first << "=" << (*attrIterator).second << ", ";
            ...
            AttributeList::iterator stylesIterator = node.styles.begin();
            
            for(; stylesIterator != node.styles.end(); stylesIterator++)
            {
                os << (*stylesIterator).first << "=" << (*stylesIterator).second << ", ";
            ...
            {
                std::cout << (*node.m_children[i]) << std::endl;
            }
